if(window.location.href == "https://h4011.github.io/test_site/index.html"){
  window.location.href = "https://h4011.github.io/test_site/"
}
// ,["",""]
var url_list;
if (location.protocol == 'https:') {
  url_list = [["contact_button","/test_site/contact.html"],["home_button","/test_site/"],["form_button","https://forms.gle/xwrbFKLGt4ny6k4N8"],["paper_button","/test_site/paper.html"]];
...
if (localStorage.getItem('lang') == "en") {
  ...
  xhr.open('GET', 'https://h4011.github.io/test_site/lang/en.txt', true);
...
if ((location.protocol == 'https:' && location.pathname == '/test_site/') || url2.match(".+/(.+?)([\?#;].*)?$")[1] == 'index.html') {
  $.getJSON("https://h4011.github.io/test_site/info.json", function(json){
    let data_info = json;
...
function titleimg() {
  ...
  } else if((location.protocol == 'https:' && location.pathname == '/test_site/paper.html') || url2.match(".+/(.+?)([\?#;].*)?$")[1] == 'paper.html'){
